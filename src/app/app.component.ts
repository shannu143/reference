...
export class AppComponent {
  ...
  products = [
    { 
      ...
      "name":"hipsocial",
      "type":"marketing",
      "description":"Manage and boost your social media marketing efforts from one central "
    },{
      "id":2,
      "name":"trackly",
      "type":"all",
      "description":"Boost productivity and grow faster with automated time tracking"
    },{
      "id":3,
      "name":"Plugins.ly",
      "type":"sales",
      "description":"One which takes up the burden of synching, orchestration"
    }
  ]
  


  headersArray =['name','type','description'];
  ...
  test1headersArray =['postId','name','email','body'];
}
